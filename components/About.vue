<template>
  <section id="about-me" class="border-b border-gray-200">
    <div class="bg-white py-16">
      <div
        class="max-w-screen-xl mx-auto flex justify-around flex-wrap items-center"
      >
          ...
          <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 ">
            <div class="sm:text-center lg:text-left">
              ...
              >
                ...
                <span class="text-bvRed">& Me</span>
              </h2>
              <p
                class="mt-4 max-w-2xl text-xl leading-7 text-gray-500 lg:mx-auto"
              >
                Technology should be the path to freedom, not frustration.
              </p>
              <div class="mt-10">
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg">
          <img
            :src="require('@/assets/images/kristian_small.jpeg')"
            class="w-full"
