<template>
  <div id="projects" class="py-16 bg-gray-50 overflow-hidden lg:py-24">
    <div
    ...
    >
      ...
      <div class="relative">
        ...
        <p class="mt-4 max-w-3xl text-xl leading-7 text-gray-500">
          Over the years I've created several sites and services. These are the
          ones I'm the most proud of.
        </p>
      </div>
